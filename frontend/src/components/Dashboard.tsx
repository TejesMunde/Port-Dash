        ...
        <div className="max-w-4xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`text-[10px] px-2 py-0.5 rounded-full flex items-center gap-1 transition-colors duration-normal ease-ferrari ${
      ...
      {info.peers.length > 0 && (
        <div className="mt-3 pt-3 border-t border-border">
          ...
          <div className="flex flex-wrap gap-1.5">
            {info.peers.map((p) => (
              <div key={p.hostname} className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-secondary text-secondary-foreground text-[11px] transition-colors duration-normal ease-ferrari hover:bg-secondary/80">
      ...
      <form onSubmit={submit} className="space-y-4 p-6">
        ...
        <div>
          ...
          <select name="dest_hostname" value={destHostname} onChange={(e: any) => setDestHostname(e.target.value)}
            className="flex h-10 w-full rounded-md border border-input bg-background px-3.5 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background transition-colors duration-normal ease-ferrari" required>
        ...
        <div>
          ...
          <select name="protocol" value={protocol} onChange={(e) => setProtocol(e.target.value as "tcp" | "udp" | "both")}
            className="flex h-10 w-full rounded-md border border-input bg-background px-3.5 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background transition-colors duration-normal ease-ferrari">
